...
def rk4_update(sys_state,h,params,derivatives):
	""" sys_state = [q1,q2,...,qz] where each q is a necessary parameter for 
	...
	for state in sys_state:
		...
		new_sys_state.append(new_state)
		
	return new_sys_state